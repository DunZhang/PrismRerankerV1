...
from train.constants import NO_TOKEN_ID, YES_TOKEN_ID
from train.data import (
    FlatDataset,
    InterleavedDataset,
    make_train_collate_fn,
)
from train.modeling import load_model_and_tokenizer
...
class MetricTracker:
    ...
    def distributed_averages(self, accelerator: Accelerator) -> dict[str, float]:
        ...
        return {
            ...
            "loss_pointwise": gathered[1].item() / total_count,
            "loss_sft": gathered[2].item() / total_count,
        }
